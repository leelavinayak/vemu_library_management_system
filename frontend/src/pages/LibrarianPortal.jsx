...
const getBookImage = (img) => {
  ...
  // Base64 or external URL — use as-is
                ...
                <div style={{
                  ...
                  {formData.imageUrl && !uploading ? (
                    (formData.imageUrl.endsWith('.pdf') || formData.imageUrl.includes('application/pdf')) ? (
                      ...
                      <img src={getBookImage(formData.imageUrl)} alt="Preview" onError={(e) => { e.target.onerror = null; e.target.src = "https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400&h=300&fit=crop"; }} style={{ width: "100%", height: "100%", objectFit: "contain", backgroundColor: "#f8fafc" }} />
                    )
                  ) : (
